    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-vscode-border overflow-hidden">
        ...
        <div className="p-4 bg-black/40 font-mono text-sm space-y-2">
          ...
          <div className="text-vscode-muted">&gt; Add authentication to the API using JWT with refresh tokens</div>
        </div>
      </div>

      <p className="text-sm text-vscode-muted">
        That's it. You describe your task in natural language. Claude reads your <code className="px-1.5 py-0.5 bg-vscode-widget-bg rounded text-xs">CLAUDE.md</code> file,
      ...
      <div className="space-y-3">
        <div className="flex gap-3 items-start">
          <span className="flex items-center justify-center w-6 h-6 rounded-full bg-blue-900/30 text-blue-300 text-xs font-bold flex-shrink-0">1</span>
          <div>
            <p className="text-sm font-medium">Claude creates task briefs</p>
            <p className="text-xs text-vscode-muted">Discrete, scopeable units of work are written to <code className="px-1 py-0.5 bg-vscode-widget-bg rounded">.avt/task-briefs/</code></p>
          </div>
        </div>
        <div className="flex gap-3 items-start">
        ...
        <div className="flex gap-3 items-start">
          <span className="flex items-center justify-center w-6 h-6 rounded-full bg-green-900/30 text-green-300 text-xs font-bold flex-shrink-0">3</span>
          <div>
            <p className="text-sm font-medium">Workers pick up approved tasks</p>
            <p className="text-xs text-vscode-muted">Specialized worker agents implement each task independently</p>
          </div>
        </div>
        <div className="flex gap-3 items-start">
          <span className="flex items-center justify-center w-6 h-6 rounded-full bg-purple-900/30 text-purple-300 text-xs font-bold flex-shrink-0">4</span>
          <div>
            <p className="text-sm font-medium">You monitor progress on the dashboard</p>
            <p className="text-xs text-vscode-muted">Agent cards, governed tasks, and activity feed update every 10 seconds</p>
          </div>
        </div>
      </div>
    </div>

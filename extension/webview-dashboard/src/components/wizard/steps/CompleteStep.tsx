    ...
    <div className="space-y-6">
      <div className="text-center">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-tier-quality/20 mb-4">
          <svg
            className="w-8 h-8 text-tier-quality"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div className="p-4 rounded-lg border border-vscode-border bg-vscode-widget-bg">
          ...
          <p className="text-sm text-vscode-muted">Minimum required test coverage</p>
        </div>

        <div className="p-4 rounded-lg border border-vscode-border bg-vscode-widget-bg">
          <h4 className="font-medium mb-2">Quality Gates</h4>
          <p className="text-2xl font-bold">{enabledGates.length}/5</p>
          <p className="text-sm text-vscode-muted">{enabledGates.join(', ') || 'None enabled'}</p>
        </div>

        <div className="p-4 rounded-lg border border-vscode-border bg-vscode-widget-bg">
          <h4 className="font-medium mb-2">Permissions</h4>
          <p className="text-2xl font-bold">{config.permissions.length}</p>
          <p className="text-sm text-vscode-muted">Claude Code allowed operations</p>
        </div>
      </div>
      ...
      <div className="p-4 rounded-lg border border-vscode-border bg-vscode-widget-bg">
        ...
        <div className="grid grid-cols-2 gap-2 text-sm">
          ...
          <div className="flex items-center gap-2">
            <span
              className={
                config.settings.mockTestsForCostlyOps ? 'text-tier-quality' : 'text-amber-400'
              }
            >
      ...
      <div className="p-4 rounded-lg border border-tier-quality/50 bg-tier-quality/10">
        <p className="text-sm">
          Click <strong>Complete Setup</strong> to save your configuration and start using the
          Collaborative Intelligence System. You can always adjust settings later using the gear
